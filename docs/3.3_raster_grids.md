...
Users can show cell values, change color and set transparency of a **Grid** by using **Settings** Panel. Using button ![button](imgs/button_3d.png) can creat a 3D surface of a **Grid** in which cell values are used as elevation.
