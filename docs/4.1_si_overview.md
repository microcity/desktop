...
**Encoding formats:**
Although MicroCity uses ANSI encoding format to read and write data, ScriptEditor and Embedded funtions uses UTF-8 encoding format to read and write data.
